...
const Footer = () => {
  return (
    <footer className='bg-background-100 px-6 py-8'>
      <FadeInWhenVisible delay={0.2}>
        <div className='bg-background-50 border border-gray-300 text-secondary-900 px-8 py-12 rounded-3xl shadow-xl max-w-7xl mx-auto'>
