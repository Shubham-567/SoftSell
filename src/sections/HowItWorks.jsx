      ...
      <div className='max-w-6xl mx-auto text-center px-6'>
        ...
        <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10'>
          ...
          <FadeInWhenVisible delay={0.6}>
            <div className='flex flex-col items-center text-center bg-background-100 border border-gray-300 text-gray-900 shadow-xl rounded-2xl p-8 transform duration-400 transition-transform hover:scale-105'>
