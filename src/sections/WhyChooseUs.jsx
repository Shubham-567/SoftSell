...
const WhyChooseUs = () => {
  return (
    <section id='why-us' className='py-10 px-5 md:py-20 bg-background-50'>
      <div className='bg-secondary-50 dark:bg-background-100 max-w-7xl mx-auto px-6 md:px-12 py-12 border border-gray-300 rounded-3xl shadow-xl grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-12 items-start'>
        {/* left headings*/}
        ...
        <div className='grid grid-cols-1 sm:grid-cols-2 gap-6'>
          ...
          <FadeInWhenVisible delay={0.4}>
            <div className='p-6 bg-background-100 dark:bg-primary-50 text-text-950 rounded-2xl border border-gray-300 shadow-lg hover:shadow-xl transform duration-400 transition-transform hover:scale-105'>
